...
% Last Modified by GUIDE v2.5 17-Oct-2016 20:27:27
...
% --- Executes on button press in adaptt.
function adaptt_Callback(hObject, eventdata, handles)
% hObject    handle to adaptt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
axes(handles.adaptt);
...
It=blkproc(rgb,[25,25],@adapt);
 imshow(It);


% Hint: get(hObject,'Value') returns toggle state of adaptt
